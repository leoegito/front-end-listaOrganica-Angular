...
//           this.fetchProductName(item.id.product.id, list.id, item.id.product);
//         }
//       }
//     }
//   }

//   fetchProductName(productId: number, listId: number, product: Product): void {
...
//           this.fetchProductName(productId, list.id, item.id.product);
//         }
//       }
//     }
//   }
...
//         if (!item.id.product.name) {
//           const productId = item.id.product.id || item.product;
//           this.fetchProductName(productId, item.id.product);
//         }
//       }
//     }
//   }

//   fetchProductName(productId: number, product: Product): void {
//     this.shoppingListService.getProduct(productId).subscribe(
//       (data: Product) => {
//         product.name = data.name;
//       },
